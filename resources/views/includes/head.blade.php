    ...
    <script type="text/javascript" src="{{ URL::asset('js/bootstrap.min.js') }}" type="text/javascript"></script>
    <script type="text/javascript" src="{{ URL::asset('js/jquery.min.js') }}" type="text/javascript"></script>
  ...
  <!--  <link href="{{ URL::asset('/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" /> -->
    ...
    <link href="{{ url('http://fonts.googleapis.com/css?family=Adamina') }}" rel='stylesheet' type='text/css'>
